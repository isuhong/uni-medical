...
// AI 엔진 구성 — 각 기능을 실서비스에서 어떤 모델이 담당하는지(투명성)
const AI_ENGINE = [
  { fn:"수요 예측",   model:"Prophet + LSTM 앙상블",
    desc:"거래처·SKU별 시계열로 향후 소진 시점과 발주 수량을 예측. 상시 품목은 통계 모델, 변동성 큰 품목은 딥러닝." },
  { fn:"결품 예측",   model:"Gradient Boosting (XGBoost)",
    desc:"재고·사용 속도·리드타임을 입력해 결품 위험을 확률로 분류. 대시보드의 '결품 위험 %'." },
  { fn:"제품 추천",   model:"협업 필터링 + 콘텐츠 기반 하이브리드",
    desc:"유사 거래처가 함께 쓰는 품목과 사용 패턴을 결합해 교차·상향 판매 후보를 도출." },
  { fn:"운영 인사이트", model:"LLM (요약·자연어 생성)",
    desc:"집계·이상치를 사람이 읽을 수 있는 브리핑으로 변환. '결품 위험 거래처 5곳' 같은 카드." },
  { fn:"이상 탐지",   model:"통계 + LLM 보조",
    desc:"사용량 급증·급감 등 예외 패턴을 탐지해 담당자에게 선제 알림." },
];
